  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
        ...
        <button
          type="button"
          className="inline-flex h-11 min-w-11 shrink-0 items-center justify-center rounded-md border border-[#0F6B78]/40 md:hidden"
          aria-expanded={open}
      ...
      {open && (
        <div
          id="nav-mobile"
          className="border-t border-[#0F6B78]/20 bg-[#fafafa] px-6 py-4 md:hidden"
        >
